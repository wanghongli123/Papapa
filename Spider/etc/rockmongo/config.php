...
$MONGO["servers"][$i]["mongo_host"] = "mongodb";//mongo host
...
// 在启动docker时'ON_PRODUCTION'字符串会被替换
$MONGO["servers"][$i]["control_auth"] = true;//enable control users, works only if mongo_auth=false
$MONGO["servers"][$i]["control_users"]["admin"] = "OU9J8DICfyYW9Vtf";//one of control users ["USERNAME"]=PASSWORD, works only if mongo_auth=false
